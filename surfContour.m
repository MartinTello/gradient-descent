function surfContour(paramsRecta, allParamsRecta, J_paramsRecta, handles)
...
superficie(m_vals, b_vals, J, paramsRecta, allParamsRecta, J_paramsRecta, handles);

% ploteo de las curvas de nivel
curvaNivel(m_vals, b_vals, J, paramsRecta, allParamsRecta, handles);